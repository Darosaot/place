					...
					try {
						...
						if (noticeInfo.getNoticeTypeCode().getValue().compareTo("DOC_PIN") != 0) {
							...
							for (AdditionalPublicationStatusType additionalPublicationStatus : noticeInfo
								...
								//Desde la versión 2.1 no se tiene en cuenta si la primera publicación es en el perfil del contratante
								//Se conserva comentado y si el resultado es satisfactorio se eliminará definitivamente en siguientes versiones
